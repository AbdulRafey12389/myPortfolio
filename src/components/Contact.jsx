...
const Contact = () => {
  return (
    <section
      ...
      className='section'
    >
      <div className='container lg:grid lg:grid-cols-2 lg:items-stretch px-10 2xl:px-0 h-[60vh]  mx-auto'>
          ...
          <div className='flex items-center gap-2 mt-auto'>
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                target='_blank'
                key={key}
                className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,colors] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up'
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action='https://getform.io/f/bejrqoka'
          method='POST'
